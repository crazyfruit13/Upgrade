...
<html>
  ...
  <button type="submit" class="btn btn-success" name="add" value="GO">Confirm</button>
</form>
     <div>
      <h1> Remove User</h1> 
      <form action="admin.php" method="post">
  ...
  <button type="submit" class="btn btn-danger" name="del" value="GO">Confirm</button>
</form>
    <div>
  ...
  <button type="submit" class="btn btn-info" name="adjust" value="GO">Confirm</button>
</form>
    </body>
<?php
    $user =  $_POST['adduser'];
...
<?php
    ...
    $total =  $_POST['total'];
    if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['adjust']))
    {
        adjust();
    }
    function adjust()
