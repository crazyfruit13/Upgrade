<html>
    ...
    <div>
      <h1> Add User &nbsp; <i class="bi bi-file-earmark-person-fill"></i></h1>
      <form>
      <div class="form-group row">
    <label for="colFormLabelLg" class="col-sm-2 col-form-label col-form-label-lg">Username To Add</label>
    <div class="col-sm-10">
     ...
     <div>
      <h1> Remove User &nbsp; <i class="bi bi-x-octagon-fill"></i> </h1> 
      <form>
      <div class="form-group row">
    <label for="colFormLabelLg" class="col-sm-2 col-form-label col-form-label-lg">Username To Remove</label>
    <div class="col-sm-10">
      <input type="text" class="form-control form-control-lg" id="colFormLabelLg" placeholder="col-form-label-lg">
      <div class="col-auto my-1">
      <button type="submit" class="btn btn-primary">Submit</button>
    ...
    <div>
      <h1> Adjust Kowskicoins &nbsp; <i class="bi bi-gem"></i></h1>
      <form>
      <div class="form-group row">
    <label for="colFormLabelLg" class="col-sm-2 col-form-label col-form-label-lg">Kowskicoin Amount</label>
    <div class="col-sm-10">
